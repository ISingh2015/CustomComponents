...
public class IEmailTextField extends JTextField {

    private int maxLength = 10, fontSize = 12;
    protected PlainDocument fieldFilter;
    private boolean upperCase;
    private boolean allowSpecialChars, allowEmailSymbol=true, allowDot=true, allowSpaceSymbol = false,allowCommaSemiColon=true;
    private Shape shape;

    public IEmailTextField() {
        this(10);
    }

    public IEmailTextField(boolean allowSpecialChars, boolean allowEmailSymbol, boolean allowDot) {
        this(10);
    ...
    public IEmailTextField(int maxlen, boolean allowSpecialChars, boolean allowEmailSymbol, boolean allowDot) {
        this(maxlen);
        this.allowSpecialChars = allowSpecialChars;
        this.allowEmailSymbol = allowEmailSymbol;
        this.allowDot = allowDot;
    ...
    public IEmailTextField(int maxLen) {
        setMaxLength(maxLen);
        ...
        addFocusListener(new FocusListener() {
            ...
            public void focusGained(FocusEvent e) {
                IEmailTextField.this.selectAll();
            }
...
//        System.out.println(allowEmailSymbol);
    ...
    /**
     * @return the allowCommaSemiColon
     */
    public boolean isAllowCommaSemiColon() {
        return allowCommaSemiColon;
    }

    /**
     * @param allowCommaSemiColon the allowCommaSemiColon to set
     */
    public void setAllowCommaSemiColon(boolean allowCommaSemiColon) {
        this.allowCommaSemiColon = allowCommaSemiColon;
    }
